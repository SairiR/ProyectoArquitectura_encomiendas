...
//                        echo "<td><a href='../../controladores/controller.php?opcion=cargarAdmi&cedula=" . $fact->getCorreo() . "' class='btn btn-success'>actualizar</a></td>";
              ...
              <form action="../../controladores/controller.php">
                  ...
                  <select name="tipopago">
                      ...
                      <option value="TargetaCredito">Targeta de Credito</option>
                  </select>
                <input type="submit" name="Selecionar Tipo Pago" value="Confirmar">
            </form>        
                  <?php
                  if($_REQUEST['tipopago']=='Efectivo'){
                      echo ' <input type="text" name="pago" placeholder="Monto a pagar" required>';
                  }else if($_REQUEST['tipopago']=='TargetaCredito'){
                      echo ' <input type="text" name="targeta" placeholder="Ingrese su Nro. Targeta" required>';
                      echo ' <input type="text" name="pago" placeholder="Monto a pagar" required>';
                  }
                  ?>
               
                <input type="hidden" value="Realizar Pago" name="opcion">
