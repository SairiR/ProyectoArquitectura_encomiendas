    ...
    <body>
        ...
        <div class="container">
          ...
          <div class="container">
             ...
             <!--<a href='../../controladores/controller.php?opcion=seleccionarLocal&correo=<?php  ?>' class="btn btn-primary" style="background-color: #E34B1B">Listar Productos</a>-->
             <!--<a href='../../controladores/controller.php?opcion=mostrarPedidos' class="btn btn-primary" style="background-color: #E34B1B">Mostrar Pedidos</a>-->
...
//y la fila que selecciono el usuario (con el codigo del producto):
                                echo "<td><a class='btn btn-primary' href='../../controladores/controller.php?opcion=cargarPedido&idProducto=". $prod->getIdProducto() ."&cantidadProd=cantidad'>Seleccionar</a></td>";
//                                echo "<td>";
