    ...
    <body>
     ...
     <div class="container">
            ...
            <form name="forming" action="../../controladores/controller.php">
               ...
               <input type="text" name="idrepartidor" value="<?php echo $producto->getIdRepartidor() ?>"required>;
                      </p> 
                ...
                <input type="hidden" value="actualizarRepartidor" name="opcion"/>
                <input type="submit" name="btningresarrep" value="Actualizar Datos Repartidor" onclick="mensajeIngArt()">
