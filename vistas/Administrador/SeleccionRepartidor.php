...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Seleccion Repartidor</title>
               ...
               <table border="1">
                   ...
                   <tbody>
                       <tr>
                           ...
                           <td><input type="text" name="precio" value="//<?php echo $producto->getPrecioVenta()?>"required></td>
                           <td><input type="number" name="cantidad" value="//<?php echo $producto->getCantidad() ?>"required></td>
                       </tr>
                   </tbody>
               </table>
